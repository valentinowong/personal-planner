...
function sanitizeTaskPayload(task: TaskLike): LocalTask {
  ...
  return {
    ...
    assignee_id: (task as TaskWindowRow).assignee_id ?? maybeLocal.assignee_id ?? null,
    assignee_display_name: (task as TaskWindowRow).assignee_display_name ?? maybeLocal.assignee_display_name ?? null,
    assignee_email: (task as TaskWindowRow).assignee_email ?? maybeLocal.assignee_email ?? null,
    title: task.title,
...
function toWindowRow(
  ...
  return {
    ...
    list_id: task.list_id ?? null,
    assignee_id: task.assignee_id ?? fallback?.assignee_id ?? null,
    assignee_display_name: task.assignee_display_name ?? fallback?.assignee_display_name ?? null,
    assignee_email: task.assignee_email ?? fallback?.assignee_email ?? null,
    title: task.title,
    notes: task.notes ?? null,
    status: task.status,
    due_date: task.due_date ?? null,
